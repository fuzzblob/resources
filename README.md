...
Most of the work is in the language specific documents for [Unity / C#](CS.md) & [C++](CPP.md) as well as the [Sound Design](SoundDesign.md) document. Anything else can be found below.
...
- [Hack A Day](https://hackaday.com/blog/)

### Testing

- [The three rules of Test Driven Development](butunclebob.com/ArticleS.UncleBob.TheThreeRulesOfTdd)
...
- [How to set the Windows path & environment variables](https://www.computerhope.com/issues/ch000549.htm)
...
- [Pro Git (free e-book)](https://git-scm.com/book/en/v2)
...
- [Blueprint For Good Government](good_government.md)
